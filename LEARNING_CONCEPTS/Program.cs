namespace LEARNING_CSHARP
{
	...
	internal static class Program
	{
		...
		private static void Main()
		{
			...
			// متغیرهایی که در داخل تابع تعریف می‌شوند که اصطلاحاً به آنها متغیر محلی گفته می‌شود
			// متغیرهایی که بیرون تابع و در درون خود کلاس تعریف می‌شوند که به آنها اصطلاحاً فیلد گفته می‌شود

			// برای دوره پیشرفته
			// قرار می‌گیرند Stack تعریف می‌شوند، در داخل function تمامی متغیرهایی که در داخل
			// می‌شوند، مطلقا مقدار اولیه ندارند Allocate قرار گرفته و یا اصطلاحاً Stack تمامی متغیرهایی که در داخل
			...
			//قرار داشته و اصطلاحاً به آن اشاره می‌کنند Heap قرار دارند ولی مقدارشان در داخل (Heap و یا Stack متغیرهایی هستند که خودشان در یک جا (یا در Reference Type متغیرهای

			// برای دوره مقدماتی
			// در زبان سی‌شارپ، هرگاه یک متغیر محلی (متغیر داخل تابع) تعریف نماییم، مطلقاً مقدار اولیه ندارد
			// قرار می‌گیرند Stack تعریف می‌شوند، در داخل function تمامی متغیرهایی که در داخل
			...
			// **********
			// خط ذیل، دقیقاً یک دستور است نه دو دستور
			//int X, Y;
			// **********
			...
			// **********
			// در زبان سی‌شارپ، در صورتی که در داخل یک بلاک بیش از یک دستور بنویسیم، موظف هستیم که حتماً
			...
			//string str2 = (10).ToString() + str1; // قبلاً مجبور بودیم
